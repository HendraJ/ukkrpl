...
<div class="card shadow mb-4" style="max-width:500px;">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold " style="color:rgb(59, 185, 255);">Isi Data Perjalanan</h6>
    </div>
    <div class="card-body">
        <form method="post" action="<?= base_url() ?>/isidata/simpan">
            ...
            <button class="btn btn-primary btn-icon-split" style="background-color:rgb(59, 185, 255);">
